...
def lazy_import():
    ...
    globals()['ScrubResult'] = ScrubResult


class ScrubResults(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, id, timestamp, results, *args, **kwargs):  # noqa: E501
        """ScrubResults - a model defined in OpenAPI

        Args:
            id (str): UUID describing the transaction
            timestamp (datetime): Server time of the transaction
            results ([ScrubResult]): Array of Scrub results
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, timestamp, results, *args, **kwargs):  # noqa: E501
        """ScrubResults - a model defined in OpenAPI
