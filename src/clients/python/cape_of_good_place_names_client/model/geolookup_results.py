...
def lazy_import():
    ...
    globals()['GeolookupResult'] = GeolookupResult


class GeolookupResults(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'results': ([GeolookupResult],),  # noqa: E501
        }
    ...
    def _from_openapi_data(cls, id, timestamp, results, *args, **kwargs):  # noqa: E501
        ...
        Args:
            ...
            results ([GeolookupResult]): Array of Geolookup results
