...
import cape_of_good_place_names_client.models
from cape_of_good_place_names_client import rest
from cape_of_good_place_names_client.exceptions import ApiValueError, ApiException
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cape_of_good_place_names_client.models, klass)
